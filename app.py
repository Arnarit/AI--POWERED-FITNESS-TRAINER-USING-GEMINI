...
try:
    ...
    base_model = genai.GenerativeModel("gemini-2.5-pro")
    # Model specifically for Langchain Q&A chain
    langchain_chat_model = ChatGoogleGenerativeAI(model="gemini-2.5-pro", temperature=0.7, google_api_key=API_KEY)
